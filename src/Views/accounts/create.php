...
<div class="max-w-4xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-800">Nuevo Servicio</h1>
            <p class="text-gray-500 text-sm mt-1">Gestión de cuentas y suscripciones.</p>
        </div>
        <a href="/accounts" class="text-gray-500 hover:text-gray-800 font-medium flex items-center bg-white px-4 py-2 rounded-lg shadow-sm border border-gray-200">
            <i class="fas fa-times mr-2"></i> Cancelar
        </a>
    </div>

    <form id="accountForm" action="/accounts/store" method="POST" class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden mb-8">
        ...
        <div class="p-8 space-y-8">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="accService" name="service_name" class="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none" required placeholder="Ej: Adobe Creative Cloud">
                    </div>
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-1">Proveedor</label>
                        <input type="text" id="accProvider" name="provider" class="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none" placeholder="Ej: Adobe Systems">
                    </div>
                    <div>
                    ...
                    <div id="licensesField" class="hidden animate-fade-in-down">
                        ...
                        <input type="number" id="accMaxLicenses" name="max_licenses" value="1" min="1" class="w-full p-2.5 border border-purple-300 bg-purple-50 rounded-lg focus:ring-2 focus:ring-purple-500 outline-none">
                    </div>
                    <div>
                         <label class="block text-sm font-bold text-gray-700 mb-1">Referencia / Contrato</label>
                         <input type="text" name="contract_ref" class="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none">
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="accUsername" name="username" class="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 outline-none" placeholder="user@example.com">
                    </div>
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-1">Password</label>
                        <input type="text" id="accPassword" name="password" class="w-full p-2.5 border border-gray-300 rounded-lg font-mono focus:ring-2 focus:ring-purple-500 outline-none">
                    </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="number" id="accCost" name="cost" value="0" step="0.01" min="0" class="w-full p-2.5 border border-gray-300 rounded-lg text-right font-bold text-gray-700 focus:ring-2 focus:ring-green-500 outline-none">
                    </div>
                    <div>
                    ...
                    <div class="col-span-1 md:col-span-3">
                        ...
                        <input type="date" id="accRenewal" name="renewal_date" class="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 outline-none">
                    </div>
                    <div class="col-span-1 md:col-span-3">
                        <label class="block text-sm font-bold text-gray-700 mb-1">Fecha de Nacimiento (si aplica)</label>
                        <input type="date" id="accBirthDate" name="birth_date" class="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 outline-none">
            ...
            <div>
                ...
                <textarea name="observations" rows="3" class="w-full p-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-gray-400 outline-none" placeholder="Notas sobre la cuenta..."></textarea>
            </div>
