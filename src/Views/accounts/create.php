...
<div class="mb-6">
    <a href="/accounts" class="inline-flex items-center bg-white px-4 py-2 border border-gray-200 shadow-sm text-gray-500 rounded-lg hover:bg-gray-50 hover:text-gray-700 transition font-medium">
        <i class="fas fa-arrow-left mr-2"></i> Volver a Cuentas
    </a>
</div>

<div class="max-w-5xl mx-auto">
    <div class="flex items-center mb-6">
        <h2 class="text-3xl font-bold text-gray-800"><i class="fas fa-key mr-3 text-yellow-500"></i>Nuevo Servicio</h2>
    </div>

    <form id="accountForm" action="/accounts/store" method="POST" enctype="multipart/form-data">
        ...
        <div class="space-y-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="accService" name="service_name" class="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition" required placeholder="Ej: Adobe Creative Cloud">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Proveedor</label>
                        <input type="text" id="accProvider" name="provider" class="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition" placeholder="Ej: Adobe Systems">
                    </div>
                    <div>
                        ...
                        <select id="accType" name="account_type" class="w-full p-2.5 border border-gray-300 rounded-lg bg-white focus:ring-2 focus:ring-blue-500 outline-none transition" onchange="toggleFamily()">
                            ...
                            <option value="Empresarial">Empresarial / Corporativa</option>
                        </select>
                    </div>
                    <div id="licensesField" class="hidden animate-fade-in-down">
                        <label class="block text-xs font-bold text-purple-700 uppercase mb-1">Max Licencias / Usuarios</label>
                        <input type="number" id="accMaxLicenses" name="max_licenses" value="1" min="1" class="w-full p-2.5 border border-purple-300 bg-purple-50 rounded-lg focus:ring-2 focus:ring-purple-500 outline-none transition">
                    </div>
                    <div class="col-span-1 md:col-span-2">
                         <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Referencia / Contrato</label>
                         <input type="text" name="contract_ref" class="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="accUsername" name="username" class="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 outline-none transition" placeholder="user@example.com">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Password</label>
                        <input type="text" id="accPassword" name="password" class="w-full p-2.5 border border-gray-300 rounded-lg font-mono focus:ring-2 focus:ring-purple-500 outline-none transition">
                    </div>
                    <div class="col-span-1 md:col-span-2">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="number" id="accCost" name="cost" value="0" step="0.01" min="0" class="w-full p-2.5 border border-gray-300 rounded-lg text-right font-bold text-gray-700 focus:ring-2 focus:ring-green-500 outline-none transition">
                    </div>
                    <div>
                    ...
                    <div class="col-span-1 md:col-span-3">
                        ...
                        <input type="date" id="accRenewal" name="renewal_date" class="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 outline-none transition">
                    </div>
                    <div class="col-span-1 md:col-span-3">
                        <label class="block text-xs font-bold text-gray-500 uppercase mb-1">Fecha de Nacimiento (si aplica)</label>
                        <input type="date" id="accBirthDate" name="birth_date" class="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 outline-none transition">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
                ...
                <textarea name="observations" rows="3" class="w-full p-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 outline-none transition" placeholder="Notas sobre la cuenta..."></textarea>
            </div>
        ...
        <div class="flex justify-end gap-3 pt-4 pb-8">
            <a href="/accounts" class="px-6 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition font-medium shadow-sm">
                Cancelar
            </a>
