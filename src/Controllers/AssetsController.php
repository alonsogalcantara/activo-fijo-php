    ...
    public function store() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
             $data = [
                ...
                'status' => !empty($_POST['status']) ? $_POST['status'] : 'Disponible',
                ...
                'acquisition_type' => !empty($_POST['acquisition_type']) ? $_POST['acquisition_type'] : 'Compra',
                'leasing_company' => !empty($_POST['leasing_company']) ? $_POST['leasing_company'] : null,
                'cost_center' => !empty($_POST['cost_center']) ? $_POST['cost_center'] : null,
                ...
                'device_user' => !empty($_POST['device_user']) ? $_POST['device_user'] : null,
                'device_password' => !empty($_POST['device_password']) ? $_POST['device_password'] : null,
                'color' => !empty($_POST['color']) ? $_POST['color'] : null,
                'material' => !empty($_POST['material']) ? $_POST['material'] : null,
                'size' => !empty($_POST['size']) ? $_POST['size'] : null,
                'gender_cut' => !empty($_POST['gender_cut']) ? $_POST['gender_cut'] : null,
                'license_plate' => !empty($_POST['license_plate']) ? $_POST['license_plate'] : null,
